...
import * as typeaheadOld from './typeaheadOld/typeahead';
...
export { defaultThemeValueName, autosaveDialogFooter, busy, button, buttonAsync, buttonLink, buttonToggle, cardContainer, checkbox, commaList, dateTime, dialog, genericContainer, lazyLoad, longClickButton, messageLog, multiStepIndicator, radio, ratingBar, richTextEditor, select, signaturePad, simpleCardList, spinner, stringWithWatermark, tabs, textarea, textbox, typeahead, typeaheadOld, userRating, validationGroup };
