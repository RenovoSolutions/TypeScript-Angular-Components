...
import { SimpleDataSourceOld, IDataSourceOld } from './simpleDataSourceOld.service';
...
describe('SimpleDataSourceOld', () => {
	...
	it('should set data set and filter count settings on base', (): void => {
		const source: IDataSourceOld<number> = new SimpleDataSourceOld([1, 2, 3], processor, __array.arrayUtility);
