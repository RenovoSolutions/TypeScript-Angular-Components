...
export var moduleName: string = 'rl.ui.components.typeaheadOld';
export var directiveName: string = 'rlTypeaheadOld';
export var controllerName: string = 'TypeaheadOldController';
...
export interface ITypeaheadBindings {
	...
	// summary: Flower-up label for the component
	label: string;

	// summary: Custom validation logic for the component
...
export class TypeaheadController {
	...
	constructor(private $scope: angular.IScope
		...
		if (!_.isUndefined(this.validator)) {
			this.typeaheadValidator = componentValidatorFactory.getInstance({
