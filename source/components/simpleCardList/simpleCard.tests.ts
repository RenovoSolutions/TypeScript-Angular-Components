...
describe('SimpleCardComponent', () => {
	...
	beforeEach(() => {
		...
		card = new SimpleCardComponent(<any>{}, null, null, new __boolean.BooleanUtility, <any>list);
	});

	it('should create an empty list if no list is provided', (): void => {
		card = new SimpleCardComponent(null, null, null, new __boolean.BooleanUtility, null);
