...
export declare class DialogService<TDialogSettings> implements IDialogService<TDialogSettings> {
    ...
    private data;
    private form;
    constructor(dialog: types.IDialogImplementation<TDialogSettings>, $rootScope: angular.IRootScopeService, autosaveFactory: IAutosaveServiceFactory, promise: IPromiseUtility, notification: __notification.INotificationService, formService: IFormService);
    open(options: TDialogSettings, closeHandler?: types.IDialogCloseHandler): types.IDialogInstance;
    prompt(options: types.IPromptSettings): types.IPromptInstance;
    openForm(options: types.IAutosaveDialogSettings): types.IAutosaveDialogInstance;
...
export interface IDialogServiceProvider<TDialogSettings> extends angular.IServiceProvider {
    ...
    $get(bootstrapModalDialog: bootstrapModalDialog.IBootstrapModalDialogService, $rootScope: angular.IRootScopeService, autosaveFactory: IAutosaveServiceFactory, promise: IPromiseUtility, notification: __notification.INotificationService, formService: IFormService): IDialogService<TDialogSettings>;
}
